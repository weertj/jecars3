...
//        mModifyUser.setEnabled( false );
  ...
  private void initComponents() {
    ...
    mRemoveMembership.setForeground(new java.awt.Color(0, 153, 0));
    mRemoveMembership.setText("Remove User Membership (As Role)");
    mRemoveMembership.setEnabled(false);
    ...
    mAddMemberShipAsRole.setForeground(new java.awt.Color(0, 153, 0));
    ...
    mRemoveMember.setText("Remove Group Member");
    mRemoveMember.setEnabled(false);
