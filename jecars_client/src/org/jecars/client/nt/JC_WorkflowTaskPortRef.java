 ...
 * @author weert
 */
public class JC_WorkflowTaskPortRef extends JC_DefaultNode {

//  public long getPortIndex() throws JC_Exception {
//    return getProperty( "jecars:portindex" ).getValueAsLong();
//  }
