...
public class WF_JcrHelper {
   ...
   /** decode contents of a String that was encoded using {@link #encode(javax.jcr.Binary) }
     ...
     * @throws WF_XmlException 
     */
    public static Binary decode( ValueFactory pVF, String encoded) throws RepositoryException, WF_XmlException {
        Binary result = pVF.createBinary( new ByteArrayInputStream( BASE64Decoder.decodeBuffer(encoded) ) );
        return result;
    }
